...
- (NSUInteger) hash
{
  ...
  hash = (hash * 31) ^ __sender_isset ? 2654435761 : 0;
  if (__sender_isset)
  {
    hash = (hash * 31) ^ [__sender hash];
  }
...
- (BOOL) isEqual: (id) anObject
{
  ...
  Message *other = (Message *)anObject;
  if ((__body_isset != other->__body_isset) ||
      (__body_isset && ((__body || other->__body) && ![__body isEqual:other->__body]))) {
    return NO;
  }
  if ((__sender_isset != other->__sender_isset) ||
      (__sender_isset && ((__sender || other->__sender) && ![__sender isEqual:other->__sender]))) {
    return NO;
  }
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[UserCredentials class]]) {
    return NO;
  }
  UserCredentials *other = (UserCredentials *)anObject;
...
- (NSUInteger) hash
{
  ...
  hash = (hash * 31) ^ __targetUserId_isset ? 2654435761 : 0;
  if (__targetUserId_isset)
  {
    hash = (hash * 31) ^ [@(__targetUserId) hash];
  }
  return hash;
}
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[NewMessage class]]) {
    return NO;
  }
  NewMessage *other = (NewMessage *)anObject;
  if ((__sender_isset != other->__sender_isset) ||
      (__sender_isset && ((__sender || other->__sender) && ![__sender isEqual:other->__sender]))) {
    return NO;
  }
  ...
  if ((__targetUserId_isset != other->__targetUserId_isset) ||
      (__targetUserId_isset && (__targetUserId != other->__targetUserId))) {
    return NO;
  }
  return YES;
}
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[fetchMessages_args class]]) {
    return NO;
  }
  fetchMessages_args *other = (fetchMessages_args *)anObject;
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[FetchMessages_result class]]) {
    return NO;
  }
  FetchMessages_result *other = (FetchMessages_result *)anObject;
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[postMessage_args class]]) {
    return NO;
  }
  postMessage_args *other = (postMessage_args *)anObject;
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[PostMessage_result class]]) {
    return NO;
  }
  PostMessage_result *other = (PostMessage_result *)anObject;
  if ((__success_isset != other->__success_isset) ||
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[ping_args class]]) {
    return NO;
  }
  ping_args *other = (ping_args *)anObject;
  if ((__credentials_isset != other->__credentials_isset) ||
      (__credentials_isset && ((__credentials || other->__credentials) && ![__credentials isEqual:other->__credentials]))) {
    return NO;
  }
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[Ping_result class]]) {
    return NO;
  }
  Ping_result *other = (Ping_result *)anObject;
  return YES;
}
